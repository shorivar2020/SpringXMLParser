...
//    public Action1(org.slf4j.Logger log) {
//        this.log = log;
//    }
//
...
//    }
//
//    public void NewProduct(Statement statement) throws SQLException {
//        statement.executeUpdate("CREATE TABLE IF NOT EXISTS Products " +
//                "(ID INTEGER, ean VARCHAR(64), part_number VARCHAR(64), doc_name VARCHAR(64)," +
//                "title VARCHAR(2560), doc_language VARCHAR(64), item_group_id VARCHAR(64)," +
//                "manufacturer VARCHAR(64), supplier VARCHAR(64), country_of_origin VARCHAR(64)," +
//                "measure_unit VARCHAR(64), StartDate TIMESTAMP, STATUS INTEGER, PRIMARY KEY (ID));");
//    }
//
//    //Create all tables
